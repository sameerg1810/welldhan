...
from app.core.security import UTC, hash_password
...
@router.post("/seed/add-passwords")
...
async def seed_data():
    ...
    pkg_ids = {
        ...
        "food_basic": new_id(),
        "food_family": new_id(),
        "combo_individual": new_id(),
        "combo_family": new_id(),
        "combo_premium": new_id(),
        "sport_premium": new_id(),
    }
    trainer_ids = {"suresh": new_id(), "ananya": new_id(), "raju": new_id(), "priya_t": new_id()}
    ...
    await db.communities.insert_many(
        [
            {
                "id": comm_ids[0],
                "name": "Lansum Elegante",
                "location": "Gachibowli, Hyderabad",
                "total_flats": 200,
                "active_families": 145,
                "manager_name": "Venkat Rao",
                "manager_phone": "9000000002",
                "manager_email": "manager@welldhan.com",
                "is_active": True,
            },
            {
                "id": comm_ids[1],
                ...
                "total_flats": 180,
                "active_families": 120,
                "manager_name": "Srinivas Reddy",
                "manager_phone": "9000000003",
                "manager_email": "srinivas@welldhan.com",
                "is_active": True,
            },
            {
                "id": comm_ids[2],
                ...
                "manager_email": "ramesh@welldhan.com",
                "is_active": True,
            },
        ]
    )
    ...
    await db.packages.insert_many(
        [
            {
                "id": pkg_ids["sport_basic"],
                "name": "Sport Basic",
                "type": "Sport",
                "members_allowed": 1,
                "sports_included": ["Badminton"],
                "food_included": False,
                "vegetables_kg_per_day": 0,
                "oils_included": False,
                "monthly_price": 2500,
                "is_active": True,
                "description": "Individual badminton sessions",
            },
            {
                "id": pkg_ids["sport_family"],
                "name": "Sport Family",
                "type": "Sport",
                "members_allowed": 4,
                "sports_included": ["Badminton", "Karate"],
                "food_included": False,
                "vegetables_kg_per_day": 0,
                "oils_included": False,
                "monthly_price": 6000,
                "is_active": True,
                "description": "Family sports training package",
            },
            {
                "id": pkg_ids["food_basic"],
                "name": "Food Basic",
                "type": "Food",
                "members_allowed": 1,
                "sports_included": [],
                "food_included": True,
                "vegetables_kg_per_day": 0.5,
                "oils_included": False,
                "monthly_price": 3500,
                "is_active": True,
                "description": "Daily organic vegetables delivery",
            },
            {
                "id": pkg_ids["food_family"],
                "name": "Food Family",
                "type": "Food",
                "members_allowed": 4,
                "sports_included": [],
                "food_included": True,
                "vegetables_kg_per_day": 2,
                "oils_included": True,
                "monthly_price": 8000,
                "is_active": True,
                "description": "Family organic food package with oils",
            },
            {
                "id": pkg_ids["combo_individual"],
                "name": "Combo Individual",
                "type": "Combo",
                "members_allowed": 1,
                "sports_included": ["Yoga"],
                "food_included": True,
                "vegetables_kg_per_day": 0.5,
                "oils_included": False,
                "monthly_price": 5500,
                "is_active": True,
                "description": "Yoga + organic food for one person",
            },
            {
                "id": pkg_ids["combo_family"],
                "name": "Combo Family",
                "type": "Combo",
                "members_allowed": 4,
                "sports_included": ["Badminton", "Yoga", "Karate"],
                "food_included": True,
                "vegetables_kg_per_day": 2,
                "oils_included": True,
                "monthly_price": 14000,
                "is_active": True,
                "description": "Complete family wellness package",
            },
            {
                "id": pkg_ids["combo_premium"],
                "name": "Combo Premium",
                "type": "Combo",
                "members_allowed": 6,
                "sports_included": ["Badminton", "Yoga", "Karate", "Swimming"],
                "food_included": True,
                "vegetables_kg_per_day": 3,
                "oils_included": True,
                "monthly_price": 20000,
                "is_active": True,
                "description": "All sports + premium organic food",
            },
            {
                "id": pkg_ids["sport_premium"],
                "name": "Sport Premium",
                "type": "Sport",
                "members_allowed": 2,
                "sports_included": ["Swimming", "Yoga"],
                "food_included": False,
                "vegetables_kg_per_day": 0,
                "oils_included": False,
                "monthly_price": 5000,
                "is_active": True,
                "description": "Swimming + Yoga for couples",
            },
        ]
    )
    ...
    await db.trainers.insert_many(
        [
            {
                "id": trainer_ids["suresh"],
                "name": "Suresh Babu",
                "phone": "9100000001",
                "email": "suresh@welldhan.com",
                "sport": "Badminton",
                "certification": "BWF Level 2",
                "experience_years": 8,
                "rating": 4.8,
                "salary": 35000,
                "is_active": True,
            ...
            {
                "id": trainer_ids["ananya"],
                "name": "Ananya Reddy",
                "phone": "9100000002",
                "email": "ananya@welldhan.com",
                "sport": "Yoga",
            ...
            },
            {
                ...
                "name": "Raju Naik",
                "phone": "9100000003",
                "email": "raju@welldhan.com",
                "sport": "Karate",
                "certification": "JKA 3rd Dan",
                "experience_years": 12,
                "rating": 4.7,
                "salary": 38000,
                "is_active": True,
            ...
            {
                "id": trainer_ids["priya_t"],
                "name": "Priya Iyer",
                "phone": "9100000004",
                "email": "priya.t@welldhan.com",
                "sport": "Swimming",
                "certification": "RLSS Lifeguard",
                "experience_years": 5,
                "rating": 4.6,
                "salary": 30000,
                "is_active": True,
    ...
    slots_data = [
        {
            "id": slot_ids[0],
            "sport": "Badminton",
            "trainer_id": trainer_ids["suresh"],
            "slot_time": "6:00 AM",
            "slot_days": ["Mon", "Wed", "Fri"],
            "max_capacity": 8,
            "current_booked": 3,
            "spots_left": 5,
            "is_available": True,
            "location": "Court A, Block 1",
            "community_id": comm_ids[0],
        },
        {
            "id": slot_ids[1],
            ...
            "trainer_id": trainer_ids["suresh"],
            "slot_time": "7:00 AM",
            "slot_days": ["Tue", "Thu", "Sat"],
            "max_capacity": 8,
            "current_booked": 7,
            "spots_left": 1,
            "is_available": True,
            "location": "Court B, Block 2",
            "community_id": comm_ids[0],
        },
        {
            "id": slot_ids[2],
            "sport": "Yoga",
            "trainer_id": trainer_ids["ananya"],
            "slot_time": "6:30 AM",
            ...
            "spots_left": 7,
            "is_available": True,
            "location": "Terrace Garden, Block A",
            "community_id": comm_ids[0],
        },
        {
            "id": slot_ids[3],
        ...
        },
        {
            "id": slot_ids[6],
            "sport": "Swimming",
            "trainer_id": trainer_ids["priya_t"],
            "slot_time": "6:00 AM",
            "slot_days": ["Mon", "Tue", "Wed", "Thu", "Fri"],
            "max_capacity": 10,
            "current_booked": 4,
            "spots_left": 6,
            "is_available": True,
            "location": "Swimming Pool, Block D",
            "community_id": comm_ids[0],
        },
        {
            "id": slot_ids[7],
    ...
    food_items = [
        ...
        },
        {
            ...
            "is_organic": True,
            "is_available": True,
            "supplier_name": "Organic Farm Hyderabad",
        ...
        },
        {
            ...
            "is_organic": False,
            "is_available": True,
            "supplier_name": "Andhra Rice Mills",
    ...
    for i, (name, email, phone, flat, pkg_id) in enumerate(household_names):
        ...
        hh = {
            ...
            "primary_email": email,
            "package_id": pkg_id,
            "plan_type": "Family" if i % 3 != 2 else "Individual",
            "total_members": 4 if i % 3 != 2 else 1,
            "is_active": True,
            "food_plan_active": pkg_id
            in [
                pkg_ids["food_basic"],
                pkg_ids["food_family"],
                pkg_ids["combo_individual"],
                pkg_ids["combo_family"],
        ...
        await db.members.insert_one(
            {
                "id": new_id(),
                "household_id": hh_id,
                "member_name": f"{name.split()[0]} Spouse",
                "age": 33 + i,
                "relation": "Spouse",
                "is_primary": False,
                "assigned_sport": sports[(i + 1) % 4],
                "is_active": True,
                "phone": "",
            }
        )
        await db.members.insert_one(
            {
                "id": new_id(),
                "household_id": hh_id,
                "member_name": f"{name.split()[0]} Jr.",
                "age": 10 + i,
                "relation": "Child",
                "is_primary": False,
                "assigned_sport": "Karate",
                "is_active": True,
                "phone": "",
            }
        )
                ...
                await db.member_food_preferences.insert_one(
                    {
                        ...
                        "food_item_id": fi_id,
                        "is_selected": True
                        if fi_key in ["tomatoes", "spinach", "rice", "milk"]
                        else (i % 2 == 0),
                        "default_quantity": 1,
                        "unit": "kg" if fi_key not in ["milk", "coconut_oil", "sunflower_oil"] else "L",
                        "pause_until": None,
    ...
    await db.admin_users.insert_one({"id": new_id(), "name": "WELLDHAN Admin", "phone": "9000000001", "email": "admin@welldhan.com"})
...
# ─── Authenticated household/user routes ──────────────────────────────────────


@router.patch("/households/me")
...
async def get_slots(sport: Optional[str] = None, current_user: dict = Depends(get_current_user)):
    ...
    for s in slots:
        ...
        s["trainer"] = strip_private_fields(trainer) if trainer else None
        s["spots_left"] = s.get("max_capacity", 0) - s.get("current_booked", 0)
        result.append(strip_private_fields(s))
    return result
...
async def create_booking(req: BookingCreate, current_user: dict = Depends(get_current_user)):
    ...
    await db.slots.update_one(
        {"id": req.slot_id},
        {"$set": {"current_booked": new_booked, "is_available": new_booked < slot.get("max_capacity", 10)}},
    )
    return {"success": True, "booking_ids": created}


@router.get("/bookings")
async def get_bookings(status: Optional[str] = None, current_user: dict = Depends(get_current_user)):
    db = get_db()
    ...
    for b in bookings:
        ...
        b["slot"] = strip_private_fields(slot) if slot else None
        b["trainer"] = strip_private_fields(trainer) if trainer else None
        b["member"] = strip_private_fields(member) if member else None
        result.append(strip_private_fields(b))
    return result
...
@router.patch("/bookings/{booking_id}/attendance")
...
async def get_food_prefs(current_user: dict = Depends(get_current_user)):
    ...
    for p in prefs:
        ...
        p["food_item"] = strip_private_fields(item) if item else None
        result.append(strip_private_fields(p))
    return result


@router.patch("/food/preferences/{pref_id}/toggle")
async def toggle_food_pref(pref_id: str, current_user: dict = Depends(get_current_user)):
    ...
    await db.member_food_preferences.update_one(
        {"id": pref_id}, {"$set": {"is_selected": new_val, "updated_at": datetime.now(UTC).isoformat()}}
    )
    return {"is_selected": new_val}


@router.post("/food/preferences/pause")
...
async def get_food_orders(current_user: dict = Depends(get_current_user)):
    ...
    for o in orders:
        ...
        o["food_item"] = strip_private_fields(item) if item else None
        result.append(strip_private_fields(o))
    return result
...
async def get_food_inventory(category: Optional[str] = None, current_user: dict = Depends(get_current_user)):
    ...
    return [strip_private_fields(i) for i in items]
...
async def get_members(current_user: dict = Depends(get_current_user)):
    ...
    return [strip_private_fields(m) for m in members]
...
async def add_member(req: MemberCreate, current_user: dict = Depends(get_current_user)):
    ...
    return strip_private_fields(member)
...
async def get_payments(current_user: dict = Depends(get_current_user)):
    ...
    for p in payments:
        ...
        p["package"] = strip_private_fields(pkg) if pkg else None
        result.append(strip_private_fields(p))
    return result
...
async def get_trainer_slots(current_user: dict = Depends(require_roles("Trainer"))):
    ...
    return [strip_private_fields(s) for s in slots]
...
async def get_trainer_students(current_user: dict = Depends(require_roles("Trainer"))):
    ...
    for m in members:
        ...
        m["household"] = strip_private_fields(hh) if hh else None
        result.append(strip_private_fields(m))
    return result


@router.get("/trainer/today-bookings")
async def get_trainer_today_bookings(current_user: dict = Depends(require_roles("Trainer"))):
    ...
    for b in bookings:
        ...
        b["member"] = strip_private_fields(member) if member else None
        b["slot"] = strip_private_fields(slot) if slot else None
        b["household"] = strip_private_fields(hh) if hh else None
        result.append(strip_private_fields(b))
    return result
...
async def manager_summary(current_user: dict = Depends(require_roles("Manager"))):
    ...
    pipeline = [{"$match": {"is_paid": False}}, {"$group": {"_id": None, "total": {"$sum": "$amount_due"}}}]
...
async def manager_households(search: Optional[str] = None, current_user: dict = Depends(require_roles("Manager"))):
    ...
    for hh in households:
        pkg = await db.packages.find_one({"id": hh.get("package_id", "")})
        hh["package"] = strip_private_fields(pkg) if pkg else None
        result.append(strip_private_fields(hh))
    return result


@router.get("/manager/pending-payments")
async def manager_pending_payments(current_user: dict = Depends(require_roles("Manager"))):
    ...
    for p in payments:
        ...
        p["household"] = strip_private_fields(hh) if hh else None
        result.append(strip_private_fields(p))
    return result
...
async def admin_summary(current_user: dict = Depends(require_roles("Admin"))):
    ...
    revenue_pipeline = [{"$match": {"is_paid": True}}, {"$group": {"_id": None, "total": {"$sum": "$amount_paid"}}}]
    rev_res = await db.payments.aggregate(revenue_pipeline).to_list(1)
    total_revenue = rev_res[0]["total"] if rev_res else 0
    pending_rev_pipe = [{"$match": {"is_paid": False}}, {"$group": {"_id": None, "total": {"$sum": "$amount_due"}}}]
...
async def get_streak(current_user: dict = Depends(get_current_user)):
    db = get_db()
    household_id = current_user["sub"]
    bookings = await db.bookings.find({"household_id": household_id, "status": "Attended"}).sort("session_date", -1).to_list(90)
